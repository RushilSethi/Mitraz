...
const Profile = () => {
  ...
  return (
    <div className="profile-container">
      <div className="h-10 bg-green-200 text-dark-2 rounded-lg flex items-center justify-between w-full p-2">
        <p className="text-sm">
          ...
          <div className="flex justify-center gap-4">
            <div className={`${user.id !== currentUser.$id && "hidden"}`}>
              <Link
                ...
                className={`h-12 bg-green-100 px-5 text-dark-1 flex-center gap-2 rounded-lg ${
        ...
        <div className="flex max-w-5xl w-full">
          <Link
            ...
            className={`profile-tab rounded-l-lg ${
              pathname === `/profile/${id}` && "!bg-green-100"
            }`}>
            <img
          ...
          <Link
            ...
            className={`profile-tab rounded-r-lg ${
              pathname === `/profile/${id}/liked-posts` && "!bg-green-100"
            }`}>
            <img
